...
function mojiOglasi(){
    $(document).ready(function(){
        inicijalizuj("nizPticaEN");    
        let Niz1 = JSON.parse(localStorage.getItem("nizPticaEN"));
        $(document).ready(function(){
            for(let i=0;i<Niz1.length;i++){
                $("#nizPticaEN").append(
                    $("<div></div>").attr("class", "col-md-6 col-lg-4 mb-4").append(
                        ...
                        .append($("<img>").attr("class", "display-3 font-weight-normal text-secondary mb-3")
                            .attr("src", Niz1[i].slika).css({
                                "width" : "250px",
                                "height": "250px",
                            }))
                        .append($("<h4></h4>").append(Niz1[i].ime))
                        .append($("<div></div>").append("Year: " + Niz1[i].godiste))
                        .append($("<div></div>").append("Weight: " + Niz1[i].tezina))
                        .append($("<a></a>").attr("class", "text-uppercase font-weight-bold").attr("href", Niz1[i].link).append("DETAILED DESCRIPTION"))   
                    ).attr("id", Niz1[i].ime)      
                )
            }
